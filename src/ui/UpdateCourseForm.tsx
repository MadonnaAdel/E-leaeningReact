...
import { OptionCat, Optionstate } from "./Filter";
import { useNavigate } from "react-router-dom";
import { getCategory } from "../utils/apiCategory";
import toast from "react-hot-toast";
import { updateCourse } from "../utils/apiCourses";
...
export default function UpdateCourseForm({ courseId, initialData }: UpdateCourseFormProps) {
    ...
    const [courseData, setCourseData] = useState({
        ...
        courseTiming: initialData.courseTiming,
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            console.error('Error occurred during course update:', error);
    ...
    return (
        ...
        >
            <h3 className="font-semibold text-lg text-center dark:text-white">Update Course Info</h3>
            <input
                type="text"
            ...
            <label htmlFor="image" className="flex items-center gap-2 p-2 rounded-md transition-all border focus:outline-none focus:ring-1 ring-violet-700 ring-offset-3 bg-stone-50 dark:border-black dark:bg-stone-900 dark:text-white">
                ...
                <span className="text-sm">Upload New Image or Video</span>
